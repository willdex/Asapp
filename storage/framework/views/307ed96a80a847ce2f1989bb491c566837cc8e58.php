...
<H2>REGISTRO DE EMPRESA</H2>    
    ...
    <div class="form-group">
        ...
        <?php echo Form::text('nombre_administrador',null,['class'=>'form-control ','placeholder'=>'Ingrese el nombre']); ?>

    </div>
    <div class="form-group">
        <?php echo Form::label('apellido_administrador','Apellidos:'); ?>

        <?php echo Form::text('apellido_administrador',null,['class'=>'form-control','placeholder'=>'Ingrese los apellidos']); ?>
    ...
    <div class="form-group">
        ...
        <?php echo Form::text('telefono_administrador',null,['class'=>'form-control','placeholder'=>'Ingrese el telefono del administrador','onkeypress'=>'return bloqueo_de_punto(event)','maxlength'=>'8']); ?>
    ...
    <div class="form-group">
        ...
        <?php echo Form::text('email',null,['class'=>'form-control','placeholder'=>'Ingrese el email']); ?>
       ...
       <?php /* <input type="text" name="latitud" id="latitud" value="0">
		...
		<div class="form-group">
			...
			<?php echo Form::text('nombre_empres',null,['class'=>'form-control','placeholder'=>'Ingrese el nombre de la empresa']); ?>
		...
		<div class="form-group" hidden="">
			...
			<?php echo Form::text('direccion','Ninguna',['class'=>'form-control','placeholder'=>'Ingrese la direccion']); ?>
		...
		<div class="form-group">
			...
			<?php echo Form::text('telefono_empres',null,['class'=>'form-control','placeholder'=>'Ingrese el numero de la empresa','onkeypress'=>'return bloqueo_de_punto(event)','maxlength'=>'15']); ?>
		...
		<div class="form-group">
			...
			<?php echo Form::text('nit',null,['class'=>'form-control','placeholder'=>'Ingrese el nit','onkeypress'=>'return bloqueo_de_punto(event)']); ?>
		...
		<div class="form-group" hidden="">
			...
			<?php echo Form::text('credito',null,['class'=>'form-control','placeholder'=>'Ingrese el credito','onkeypress'=>'return bloqueo_de_punto(event)','maxlength'=>'3']); ?>

		</div>
		<input type="hidden" name="id_administrador" id="id_administrador" value="0">
...
<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	...
	<div class="pull-right">
	   ...
	   <button id="bt_add" type="button" class="btn-sm btn-success" hidden="" onclick="nuevo()"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
	</div>
