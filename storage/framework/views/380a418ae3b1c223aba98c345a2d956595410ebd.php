...
<img class="girar" src='<?php echo e(asset('images/cargar.png')); ?>' width="300px" height="300px" style='margin:0 auto; position: absolute; top: 30%; left: 42%; margin: -30px 0 0 -30px; '>
