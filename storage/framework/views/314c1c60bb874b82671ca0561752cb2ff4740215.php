<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    ...
    <div class="form-group">
        ...
        <?php echo Form::text('telefono',null,['class'=>'form-control','maxlength'=>'8','placeholder'=>'Ingrese el telefono', 'onkeypress'=>'return bloqueo_de_punto(event)']); ?>

    </div>

    <div class="form-group" >
        <label>Empresa:</label>
        <?php echo Form::select('id_empresa',$empresa,null,array('class'=>'form-control selectpicker','data-live-search'=>'true')); ?>
...
<?php //ESTO ES EL REGISTRO DE LAS DIRECCIONES CON GOOGLE MAPS 
/*<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
    
    <button id="bt_add" type="button" class="btn btn-success pull-right" onclick="nuevo()"><i class="fa fa-plus-square" aria-hidden="true"></i></button>
