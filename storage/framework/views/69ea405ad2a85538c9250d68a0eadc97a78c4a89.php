...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">		
<?php echo e(Form::open(array('url' => 'notificacion_busqueda_motista'))); ?>  
		<div id="notificacion" hidden="">
			...
			<div class="pull-right">
				<?php echo Form::submit('ENVIAR',['class'=>'btn-sm btn-primary','id'=>'btn_notificacion','onclick'=>'btn_esconder()']); ?>
...
<?php echo Html::script('js/busqueda_moto.js'); ?>
