...
<div class="modal fade" id="ModalPagoEmpresa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static">
  ...
  <?php echo Form::open(['route'=>['pago_empresa.store','null'],'method'=>'POST','onKeypress'=>'if(event.keyCode == 13) event.returnValue = false;']); ?>   
  ...
  <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12" align="center">
        ...
        <input type="hidden" name="codigo" id="codigo" value="<?php echo e($codigo); ?>"><br>
