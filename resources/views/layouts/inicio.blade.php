...
<html>
  <head>
    ...
    <link rel="apple-touch-icon" href="{{asset('images/cargar.png')}}">
    <link rel="shortcut icon" href="{{asset('images/cargar.png')}}">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="{!!URL::to('pago_motista')!!}"><i class="fa fa-bicycle"></i> Motistas</a></li>
                <li><a href="{!!URL::to('pago_empresa')!!}"><i class="fa fa-building"></i> Empresas</a></li>
                <li><a href="{!!URL::to('tarifa')!!}"><i class="fa fa-money"></i> Tarifa</a></li>
                <li><a href="{!!URL::to('lista_pago_empresa')!!}"><i class="fa fa-money"></i>Historial cobro empresa</a></li>
                <li><a href="{!!URL::to('lista_pago_moto')!!}"><i class="fa fa-money"></i>Historial cobro motista</a></li>
              </ul>
            </li> 
            ...
            <li class="treeview">
              <a href="{!!URL::to('busqueda_motista')!!}">
