<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
    ...
    <div class="form-group">
        ...
        {!!Form::text('telefono',null,['class'=>'form-control','maxlength'=>'8','placeholder'=>'Ingrese el telefono', 'onkeypress'=>'return bloqueo_de_punto(event)'])!!}
    </div>

    <div class="form-group" >
        <label>Empresa:</label>
        {!!Form::select('id_empresa',$empresa,null,array('class'=>'form-control selectpicker','data-live-search'=>'true'))!!}
