...
class Firebase {
   ...
   // Esta función hará que la solicitud curl real al servidor firebase  y luego el mensaje sea enviado 
    ...
    private function sendPushNotification($fields) {
        ...
        $headers = array(
            'Authorization: key= AAAAyXWJUD8:APA91bEbGwwJpWeIKxvHthSWgP9RJaYdliuziBeTbYkyX_e0OHHRzrg3N2dvM_eY5UoIJ8Myg0A2DtT22pPOnZLWOuTxPfU7RYWUh3rvpqpKzTISoxmIAwYMZFqEMaWy0oi6Pvhlv7cc',
